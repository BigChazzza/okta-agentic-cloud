...
export const PATTERNS: Pattern[] = [
  ...
  },
  {
    ...
    agentHealthUrl: process.env.P4_AGENT_INTERNAL_URL ?? "http://localhost:3400",
    rightPanel: "chat",
    requiresUserToken: true,
    buildStatus: "done",
    hasAgentStatus: true,
  },
  {
    ...
    agentHealthUrl: process.env.P5_AGENT_INTERNAL_URL ?? "http://localhost:3500",
    rightPanel: "chat",
    requiresUserToken: true,
    buildStatus: "pending",
  ...
  },
  {
    ...
    agentHealthUrl: process.env.P6_AGENT_INTERNAL_URL ?? "http://localhost:3600",
    rightPanel: "mission",
