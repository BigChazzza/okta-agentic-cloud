...
const HR_API_URL = process.env.HR_API_URL ?? "http://localhost:3101";
...
app.use((_req, res, next) => {
  const _allowedOrigin = (process.env.CONSOLE_URL ?? "http://localhost:3020"); res.setHeader("Access-Control-Allow-Origin", _allowedOrigin);
